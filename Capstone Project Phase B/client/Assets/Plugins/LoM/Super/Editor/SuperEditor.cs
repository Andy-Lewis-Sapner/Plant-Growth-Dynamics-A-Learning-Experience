    ...
    {        
        ...
        private void DrawImprovedFields(SuperSerializedProperty field)
        {
            ...
            else if (field.Attributes.IsTab)
            {
                ...
                {
                    field.enumValueIndex = Convert.ToInt32(field.enumValueIndex);
                    EditorUtility.SetDirty(target);
                }
            }
