...
namespace LoM.Super.Serialization
{
    ...
    internal static class SuperSerializationUtility
    {
        ...
        internal struct UnityObjectInfo
        {
            ...
            {
                bool isCodeSmellAllowed = EditorPrefs.GetBool("SuperBehaviour.CodeSmells.Enabled", true);
                m_fields = m_type
                    .GetFields(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance)
                    .Where(f => (f.GetCustomAttributes(typeof(SerializeField), true).Length > 0 || f.GetCustomAttributes(typeof(SerializableAttribute), true).Length > 0 || (f.IsPublic && isCodeSmellAllowed))
