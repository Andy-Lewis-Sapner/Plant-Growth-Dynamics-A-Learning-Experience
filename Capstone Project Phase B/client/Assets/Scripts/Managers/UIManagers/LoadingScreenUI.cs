...
public class LoadingScreenUI : Singleton<LoadingScreenUI> {
    ...
    private void Start() { // Called on first frame — sets loading text to pulse continuously
    ...
    private void ClosingLoadingScreenSequence() {// Called after the screen is hidden to finalize the transition
    ...
    public void ShowNotification(string message) {
        ...
        notificationPanel.DOFade(1f, NotificationFadeDuration).OnComplete(() => {
            ...
            notificationPanel.DOFade(0f, NotificationFadeDuration).OnComplete(() => {
